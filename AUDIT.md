...
| M2 | `text_parser.py:_BPM_RE` | **BPM regex solo acepta 2–3 dígitos** (`\d{2,3}`), ignorando "9bpm" o "1200bpm". Además no hay validación del rango [40, 300]; se acepta "999bpm" o "0bpm" sin error. | `parse_text("9bpm Am C")` → usa 120 por defecto en silencio |
